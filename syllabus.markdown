...
<!--
|<img src="{{site.book_required_image}}" name="Book" border="0px" width="100px">| **[{{ site.book_required }}]( {{ site.book_required_link }})** {{ site.book_required_edition }}<br> {{ site.book_required_author }} <br> {{ site.book_required_note }}  |
-->
